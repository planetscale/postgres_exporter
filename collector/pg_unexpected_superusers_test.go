...
func TestPGUnexpectedSuperusersCollectorNoUnexpected(t *testing.T) {
	...
	convey.Convey("Only expected superuser present", t, func() {
...
func TestPGUnexpectedSuperusersCollectorWithUnexpected(t *testing.T) {
	db, mock, err := sqlmock.New()
	if err != nil {
		t.Fatalf("Error opening a stub db connection: %s", err)
	}
...
func TestPGUnexpectedSuperusersCollectorNoSuperusers(t *testing.T) {
	db, mock, err := sqlmock.New()
	if err != nil {
		t.Fatalf("Error opening a stub db connection: %s", err)
	}
